...
from GenealogyViewer.apps.web.models import FamilyTree
...
class Person(PrimaryObject):
    ...
    birth = models.ForeignKey("Event", on_delete=models.SET_NULL, related_name="birth", blank=True, null=True)
    death = models.ForeignKey("Event", on_delete=models.SET_NULL, related_name="death", blank=True, null=True)
    
    families = models.ManyToManyField('Family', blank=True, through="MyFamily", related_name='my_families')
    parent_family = models.ForeignKey('Family', on_delete=models.SET_NULL, related_name="parent_family", blank=True, null=True)
...
class Family(PrimaryObject):
    father = models.ForeignKey('Person', on_delete=models.SET_NULL, related_name="father_ref", null=True, blank=True)
    mother = models.ForeignKey('Person', on_delete=models.SET_NULL, related_name="mother_ref", null=True, blank=True)
    ...
    marriage = models.ForeignKey("Event", on_delete=models.SET_NULL, related_name="marriage", blank=True, null=True)
